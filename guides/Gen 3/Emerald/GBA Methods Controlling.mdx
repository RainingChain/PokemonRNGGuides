...
In average, it takes 775 cycles. The top 0.1% fastest PID takes 532 cycles or less.

In a typical wild encounter, the modulo operation is called 80 times. The total difference between the fastest and slowest lead PID is 70_560 cycles.
