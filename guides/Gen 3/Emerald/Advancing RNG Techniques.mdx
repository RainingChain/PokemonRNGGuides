...
Hitting your final target with Painting Reseeding requires 2 actions, each with a different wait time:
  - Frames before painting: Visual frames before doing the technique
...
After performing it, players need to validate whether they successfully hit their target frames before painting. If succesful, players then create a Battle Video to save and restore their RNG state in case they miss their target advances after painting for the Pokémon encounter.

Battle Video can also be used to help the target frames before painting.
...
Here's an example to understand Painting Reseeding with Battle Video for the target advance 100,000,000, which has "Frames before painting: 44,572" and "Advances after painting: 33,604".
 ...
 1. You fly to Victory Road and catch a Pokemon. Based on the PokemonNO_PROD stats, you determine whether you hit the target frames before painting. (Whether the caught Pokemon exists near the RNG advance 99.9M).
 1. If you failed, you calibrate, and go back to step 2.
 1. If you succeed to hit your target frames before painting, you go make a new Battle Video. NO_PROD
